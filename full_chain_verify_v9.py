...
try:
    from param_pool.task_scheduler import validate_logic_reversal_no_future
...
print("\n--- P0-1: NaN显式替换为0 ---")
try:
    from param_pool.task_scheduler import _check_state_transition, _BacktestState
    import pandas as pd
    import numpy as np
...
try:
    ...
    from param_pool.task_scheduler import _get_expiry_slippage_multiplier
    import pandas as pd
...
print("\n--- N1: 质量标记阻断开仓 ---")
try:
    from param_pool.task_scheduler import _try_open, _BacktestState
    import pandas as pd
