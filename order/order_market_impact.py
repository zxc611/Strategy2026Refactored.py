...
R27: 从order_service.py提取的市场冲突成交概率计算函数
...
def almgren_chriss_impact(
    ...
    参数 Almgren & Chriss (2001), "Optimal Execution of Portfolio Transactions"
    ...
    Args:
        ...
        avg_daily_volume: 日均成交叉。

        daily_volatility: 日波动率

        participation_rate: 参与审volume/avg_daily_volume
