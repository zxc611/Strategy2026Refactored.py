...
from ali2026v3_trading.infra.shared_utils import safe_int as _safe_int, compute_content_hash as _compute_content_hash
...
def rollback_param_version(version: int) -> bool:
    ...
    with _param_table_lock:
        ...
        if target is None:
            return False
        from ali2026v3_trading.config.config_params import _param_table_cache as _cache_ref
        import ali2026v3_trading.config.config_params as _cp
