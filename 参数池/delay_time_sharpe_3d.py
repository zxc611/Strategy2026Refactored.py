...
MAPPING_DB = "delay_time_sharpe_3d.duckdb"
...
DELAY_TIERS = [0, 10, 15, 20, 25, 30, 35, 40, 45, 50, 60, 70, 80, 90, 100, 120, 140, 160, 180, 200]
...
STRATEGY_NAMES = ["high_freq", "resonance", "box", "spring"]
...
class DelayTimeSharpe3D:
    ...
    def _init_tables(self):
        ...
        if existing == 0:
            for d in DELAY_TIERS:
                self.conn.execute(
                    "INSERT INTO delay_tiers VALUES (?, ?, ?)",
    ...
    def _apply_time_params_to_backtest(
        ...
        if strategy == "high_freq":
            ...
            base_confirm_bars = int(params.get("state_confirm_bars", 3))
    ...
    def _run_single_backtest(
        ...
        if run_fn_name == "run_backtest_hft":
            if run_backtest_hft is None:
                ...
                return {"sharpe": 0.0, "total_return": 0.0, "max_drawdown": 0.0, "num_signals": 0, "error": "run_backtest_hft is None"}
            ...
            if run_backtest is None:
                ...
                return {"sharpe": 0.0, "total_return": 0.0, "max_drawdown": 0.0, "num_signals": 0, "error": "run_backtest is None"}
            ...
            if run_backtest_box_extreme is None:
                ...
                return {"sharpe": 0.0, "total_return": 0.0, "max_drawdown": 0.0, "num_signals": 0, "error": "run_backtest_box_extreme is None"}
            ...
            if run_backtest_box_spring is None:
                ...
                return {"sharpe": 0.0, "total_return": 0.0, "max_drawdown": 0.0, "num_signals": 0, "error": "run_backtest_box_spring is None"}
    ...
    def _calculate_hmm_sharpes(
        ...
        iv_vals = bar_data["iv"].values[:n_bars]
        ...
        for label, mask_fn in [
            ...
            if len(regime_returns) > 10:
                ...
                hmm_sharpes[label] = (
                    np.sqrt(252 * 240) * mean_r / std_r if std_r > 1e-10 else 0.0
                )
            ...
            with ThreadPoolExecutor(max_workers=max_workers) as executor:
                ...
                for future in as_completed(futures):
                    ...
                    try:
                        ...
                        r = {"sharpe": 0.0, "total_return": 0.0, "max_drawdown": 0.0, "num_signals": 0}
...
def main():
    ...
    try:
        pre_conn = duckdb.connect(args.preprocessed_db, read_only=True)
