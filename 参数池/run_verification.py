...
PARAM_POOL_DIR = Path(r"C:\Users\xu\AppData\Roaming\InfiniTrader_SimulationX64\pyStrategy\demo\ali2026v3_trading\参数池")
...
def generate_report():
    ...
    report_path = PARAM_POOL_DIR / f"verification_report_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
    with open(report_path, "w", encoding="utf-8") as f:
        json.dump({"timestamp": datetime.now().isoformat(), "grade": grade, "results": VERIFICATION_RESULTS}, f, indent=2, ensure_ascii=False)
