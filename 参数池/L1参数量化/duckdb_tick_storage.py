...
class DuckDBTickStorage:
    ...
    def bulk_import_parquet(self, parquet_path: str) -> int:
        ...
        try:
            ...
            count_before = count_before[0] if count_before else 0  # R27-P1-FIX: fetchone() None保护
            ...
            count_after = count_after[0] if count_after else 0  # R27-P1-FIX: fetchone() None保护
    ...
    def get_stats(self) -> StorageStats:
        try:
            ...
            total_rows = total_rows[0] if total_rows else 0  # R27-P1-FIX: fetchone() None保护
