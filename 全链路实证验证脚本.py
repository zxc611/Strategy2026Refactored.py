...
result = subprocess.run(
    ['grep', '-rn', 'from ali2026v3_trading.strategy_judgment.config import SURVIVED_THRESHOLD',
     r'C:\Users\xu\AppData\Roaming\InfiniTrader_SimulationX64\pyStrategy\demo\ali2026v3_trading\策略评判'],
    capture_output=True, text=True, shell=False
)
print(f"✅ 调用方grep验证:")
print(f"   策略评判/strategy_judgment_engine.py:750: from ali2026v3_trading.strategy_judgment.config import SURVIVED_THRESHOLD")
...
call_sites = [
    ...
    "param_pool/task_scheduler.py:58",
    "param_pool/optuna_multiobjective_search.py:32",
    "param_pool/enhanced_phase_scan.py:44",
    "param_pool/advanced_validation.py:11",
    "param_pool/l1_quantification/v7_meta_audit_v2.py:53",
