...
class Strategy2026(BaseStrategy, UIMixin):
    ...
    def __init__(self, *args, **kwargs):
        ...
        from ali2026v3_trading.strategy_core_service import StrategyParams, StrategyCoreService
    ...
    def _ensure_runtime_config_loaded(self) -> None:
        ...
        self.config = merged
        from ali2026v3_trading.strategy_core_service import StrategyParams
