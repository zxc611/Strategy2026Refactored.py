...
from data.width_cache import WidthStrengthCache, _NoOpDiagnosisProbeManager
from config.params_service import get_params_service
from infra.shared_utils import to_float32
...
class TTypeService:
    ...
    def _extract_strike_price(instrument_id: str) -> float:
        ...
        从期权合约代码提取行权价
        """
        from infra.shared_utils import extract_strike_price
    ...
    def register_option_contract(self, instrument_id: str, underlying_product: str,
        ...
        if wc:
            ...
            from infra.health_monitor import diagnose_register_option_result
