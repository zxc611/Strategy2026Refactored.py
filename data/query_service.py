...
from infra.maintenance_service import _normalize_code
...
from data.query_instrument_service import (
    InstrumentQueryService,
    _QueryInstrumentMixin,
)

from data.query_data_export import (
    DataExportService,
...
def get_query_service(storage_instance=None) -> 'QueryService':
    ...
    if _query_service_instance is None:
        if storage_instance is None:
            try:
                from data.data_manager import InstrumentDataManager
