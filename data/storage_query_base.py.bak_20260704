...
from ali2026v3_trading.config.config_params import DATA_CLEANING_RULES
import logging
import os
import json
import time
...
class StorageQueryBaseService:
    ...
    def _make_instrument_info(
        ...
        **extra: Any,
        ...
        from ali2026v3_trading.infra.shared_utils import extract_product_code, ShardRouter
