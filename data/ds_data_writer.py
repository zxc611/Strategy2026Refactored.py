...
class DataWriterMixin:
    ...
    def _compute_implied_volatility(last_price, strike_price, days_to_expiry, option_type, underlying_price=None) -> float:
        ...
        if option_type not in ('CALL', 'PUT'):
            return None
        try:
            from governance.greeks_calculator import IVCalculator
        ...
        try:
            if storage_db_path:
                ...
                if storage_db_path == os.path.normpath(getattr(self, 'DB_FILE', '')):
                    ...
                    from data.db_adapter import connect as _db_connect
            ...
            if not tables:
                ...
                from data.ds_schema_manager import get_ticks_raw_create_sql
