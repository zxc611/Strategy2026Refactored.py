...
- ✅ 向后兼容：所有 from ali2026v3_trading.config.config_service import xxx 不变
...
from ali2026v3_trading.config.config_logging import (  # noqa: F401
    FlushHandler,
    AuditLogger,
...
from ali2026v3_trading.config.config_loader import (  # noqa: F401
...
class ConfigService:
    ...
    def _update_from_dict(self, config_dict: Dict[str, Any]) -> None:
        ...
        try:
            from ali2026v3_trading.config.config_params import validate_ui_params
    ...
    def check_version_alignment(self, code_version: str = None,
        ...
        # 获取各版本号
        try:
            from ali2026v3_trading.infra.shared_utils import _CODE_VERSION
