...
class PositionService(object):
    ...
    TP_SL_REASON_DEFAULTS = {  # R17-P1-DOC-P1-09修复: 来源 V7.0手册§9.1/9.2 状态分层止盈止损比率
        ...
        'INCORRECT_REVERSAL': (1.3, 0.60), 'OTHER_SCALP': (1.1, 0.30), 'BOX_SPRING': (2.0, 0.40),  # FIX-20260711-P2: tp从5.0降至2.0/sl从0.60收紧至0.40（原5.0在期权上不可实现，待回测标定确认）
    }
    ...
    _HARDCODED_REASON_DEFAULTS = {
        ...
        'BOX_SPRING': (2.0, 0.40),  # FIX-20260711-P2: tp从5.0降至2.0/sl从0.60收紧至0.40
