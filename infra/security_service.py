...
def get_sensitive_credential(key_name: str, caller_id: str = '') -> str:
    ...
    try:
        ...
        from config.config_params import DEFAULT_PARAM_TABLE, _param_table_cache, _param_table_lock
...
from infra.serialization_utils import (
...
from infra.shared_utils import safe_float, safe_int, safe_get_float, safe_get_int

from risk.risk_support import structured_audit_log
