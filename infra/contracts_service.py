# [M1-71] 服务契约
# MODULE_ID: M1-086
"""contracts_service.py - 契约与特性标志服务合�?
合并�?service_contracts.py + system_contracts.py + phase_feature_flag.py (2026-06-12)
"""
...
class PhaseFeatureFlag:
    ...
    def disable_all(cls) -> None:
        with cls._lock:
            for k in cls._flags:
                cls._flags[k] = False
            logging.critical("[FeatureFlag] 全局紧急回�? 所有Feature Flag已关�?)
