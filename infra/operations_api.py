...
class OperationsAPI:
    ...
    def __init__(self):
        ...
        try:
            from infra.maintenance_service import get_capacity_stress_test, get_sop_manager
    ...
    def force_backupbackup_database(self, force: bool = False,
        ...
        """数据库备份"""
        try:
            from infra.maintenance_service import StorageMaintenanceService
            from infra.service_container import ServiceContainer
            sc = ServiceContainer()
            ...
            pass
        try:
            from infra.maintenance_service import get_backup_service
    ...
    def get_audit_log(self, last_n: int = 50) -> List[Dict[str, Any]]:
        """获取最近的操作审计日志"""
        try:
            from risk.risk_service import _get_audit_log_path
