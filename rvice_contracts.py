...
from ali2026v3_trading.infra.registry_service import (  # 去重：StateStore规范版本位于 registry_service.py
    StateSnapshot, StateStore, get_state_store, reset_state_store,
)
from ali2026v3_trading.infra.metrics_registry import PhaseFeatureFlag  # 去重：PhaseFeatureFlag规范版本位于 metrics_registry.py
