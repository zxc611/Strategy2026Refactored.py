...
from config.params_service import _read_param, get_param_value
...
class LifecycleInit:
    ...
    def on_init(self, *args, **kwargs) -> bool:
        ...
        with p._lock:
            ...
            try:
                ...
                # Step1: 品种加载
                from config.config_service import ensure_products_with_retry
    ...
    def _init_t_type_service_and_preload(self, storage) -> None:
        ...
        from data.data_service import get_latest_price
    ...
    def _fetch_china_holidays(year: Optional[int] = None) -> List:
        ...
        try:
            ...
            req.add_header('User-Agent', 'demo/1.0')
