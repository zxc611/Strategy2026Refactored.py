...
from strategy._shadow_types import AlphaMetrics
from infra.shared_utils import CHINA_TZ, DEFAULT_RISK_FREE_RATE, ANNUALIZE_FACTOR_DAILY
from infra.serialization_utils import json_dumps  # R4-5: 统一json_dumps
...
class ShadowStrategyPnLMetricsService:
    ...
    def compute_alpha_metrics(self) -> AlphaMetrics:
        with self._lock:
            ...
            try:
                import numpy as _np
                from strategy_judgment.jensen_alpha import compute_jensen_alpha
...
__all__ = ['ShadowStrategyPnLMetricsService', 'ShadowStrategyPnLMetricsMixin', 'ShadowStrategyPnLService', 'ShadowStrategyPnLMixin']
