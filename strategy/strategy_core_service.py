...
class StrategyCoreService:
    ...
    _PHASE2_GETATTR_MAP = {'_state':'_lifecycle_mgr','_is_running':'_lifecycle_mgr','_is_paused':'_lifecycle_mgr','_destroyed':'_lifecycle_mgr','_initialized':'_lifecycle_mgr','_lock':'_lifecycle_mgr','_stats':'_lifecycle_mgr','_safety_meta_layer':'_lifecycle_mgr'}
