...
class TickHandlerMixin:
    ...
    def _init_tick_handler_mixin(self) -> None:
        ...
        from ali2026v3_trading.infra.callback_registry import get_callback_group, ON_TICK
    ...
    def _tick_probe_layer(self, tick: Any) -> str:
        ...
        diag_on = False
        try:
            from ali2026v3_trading.infra.diagnosis_service import is_monitored_contract
        ...
        from ali2026v3_trading.infra.diagnosis_service import record_tick_probe, DiagnosisProbeManager
        ...
        try:
            ...
            if _sub_mgr:
                try:
                    ...
                    from ali2026v3_trading.infra.diagnosis_service import record_tick_probe
            ...
            if not bool(getattr(self, '_historical_load_in_progress', False)):
                try:
                    if not hasattr(self, '_pullback_mgr_ref'):
                        try:
                            from ali2026v3_trading.strategy.box_spring_strategy import BoxSpringStrategy
