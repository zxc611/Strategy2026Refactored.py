...
__all__ = [
    ...
    'DbQueryTimeout', 'Watchdog', 'HeartbeatMonitor', 'SignalExpiryManager',
    'CircuitBreakerHalfOpen', 'ThreadPoolGuard', 'SlowQueryDetector',
    'DataStalenessDetector', 'MemoryPressureGuard', 'AtomicConfigRef',
    'RateLimitedLogger', 'GracefulDegradation', 'BoundedQueue',
    'ResourceLeakDetector', 'AsyncTaskTimeout', 'BatchPartitioner',
    'safe_callback_wrapper', 'ProcessHealthState',
    ...
    'KahanSummation', 'safe_divide', 'SubscriberSnapshotGuard',
    'ConfigSnapshot', 'ShadowSyncBarrier', 'SharedStateRegistry',
    'StrategyRegistry', 'ParamVersionManager', 'SignalLifecycleManager',
    'get_process_health', 'get_strategy_registry',
    'get_param_version_manager', 'get_signal_lifecycle',
    'compat_round', 'compat_float_to_int',
    'is_disk_full_error',
]
...
# R33-P1-16修复: 磁盘满(ENOSPC)检测工具
import errno as _errno

def is_disk_full_error(exc: Exception) -> bool:
    """判断异常是否为磁盘满(ENOSPC)导致"""
