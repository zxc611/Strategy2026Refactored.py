...
from ali2026v3_trading.策略评判 import (
...
def example_with_cycle_resonance():
    ...
    result = hooks.on_backtest_finish(symbol="au", backtest_period="2025-01")
...
def example_standalone_diagnosis():
    ...
    from ali2026v3_trading.策略评判.market_snapshot_collector import MarketSnapshot
