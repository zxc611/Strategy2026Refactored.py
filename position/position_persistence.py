...
from infra.serialization_utils import json_dumps, json_loads, safe_jsonl_append_line
from infra.shared_utils import atomic_replace_file  # R8-5
...
class PositionPersistenceService:
    ...
    def _load_position_configs(self) -> None:
        try:
            ...
            from position.position_service import PositionLimitConfig
            config = get_config()
