# R33-P1-3标记: 此模块为死代码 — 全仓零生产引用
# 仅被tests引用
# 待决策: 集成到生产链路 或 删除
import warnings
warnings.warn(
    "performance_tier_manager is dead code (P1-3): zero production references. Pending integration or removal.",
    DeprecationWarning,
    stacklevel=2,
)
import logging
...
# R33-P1-3修复: 此模块已集成到task_scheduler.py的回测管线，不再是死代码
