...
from param_pool.backtest.backtest_runner_base import run_backtest as _run_backtest
from param_pool.ts.ts_result_writer import _load_data_for_period
...
class TestDesignSuite:
    ...
    def _run_single_test(self, test_name: str, params: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        if test_name == "hft_temporal_robustness":
            try:
                from param_pool.validation.adv_validation_misc import AdvancedValidation
    ...
    def _run_validate_test(self, test_name: str, params: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        try:
            if test_name == "validate_tick_rounding_impact":
                from risk.crack_validation import validate_tick_rounding_impact
                ...
                from param_pool.validation.validation_deep_orchestrator import validate_state_window_boundary_jitter
                ...
                from param_pool.validation.validation_deep_orchestrator import validate_hmm_online_vs_offline
                ...
                from param_pool.optimization.sensitivity import validate_hmm_perturbation_sensitivity
                ...
                from risk.crack_validation import validate_indicator_multiscale_consistency
                ...
                from param_pool.validation.validation_deep_orchestrator import validate_trend_score_bar_vs_tick_correlation
                ...
                from strategy.shadow_strategy_pnl import ShadowStrategyPnl
...
class ExecutionChecklist:
    ...
    def run_all(self) -> Dict[str, bool]:
        ...
        try:
            from demo import __version__ as _ver
            self._dynamic_results["version_recorded"] = bool(_ver)
        except (ImportError, AttributeError):
            try:
                import pkg_resources
                _ver = pkg_resources.get_distribution("").version
                self._dynamic_results["version_recorded"] = bool(_ver)
