# [M1-105] L2优化器
# MODULE_ID: M1-172
from infra.trading_utils import get_spawn_context  # NEW-P2-03修复
...
STRATEGY_IDS = ['s1_hft', 's2_resonance', 's3_box', 's4_spring', 's5_arbitrage', 's6_market_making', 's7_divergence']  # R16-P0-NAMING修复: s2_minute→s2_resonance与strategy_ecosystem/shadow_strategy_engine对齐
