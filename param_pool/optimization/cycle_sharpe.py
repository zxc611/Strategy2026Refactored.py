...
try:
    ...
    try:
        ...
        try:
            from ali2026v3_trading.param_pool.backtest.backtest_config import SLIPPAGE_BPS as _bt_slippage
...
def _build_time_params():
    T = TimeParams
    return {
        "high_freq": {d: T(m, tk, 0, d, pm) for d, m, tk, pm in [
        ...
        "resonance": {d: T(m, 0, b, d) for d, m, b in [
        ...
        "arbitrage": {d: T("lead", tk, 0, d, "microstructure") for d, tk in [
            (0,0),(10,1),(15,1),(20,1),(25,1),(30,1),(35,2),(40,2),(45,2),(50,2),
            (60,2),(70,3),(80,3),(90,3),(100,3),(120,4),(140,4),(160,5),(180,5),(200,6),
        ]},
        "market_making": {d: T("lead", tk, 0, d, "order_flow") for d, tk in [
            (0,0),(10,1),(15,1),(20,1),(25,1),(30,1),(35,2),(40,2),(45,2),(50,2),
            (60,2),(70,3),(80,3),(90,3),(100,3),(120,4),(140,4),(160,5),(180,5),(200,6),
        ]},
    }
