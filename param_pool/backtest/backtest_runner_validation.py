...
from ali2026v3_trading.infra.shared_utils import safe_price_check  # noqa: F401
...
def _check_safety(
    ...
    from ali2026v3_trading.param_pool import backtest_runner_validation as _bsc
...
def _check_state_transition(
    ...
    try:
        from ali2026v3_trading.data.width_cache import get_width_strength_cache
