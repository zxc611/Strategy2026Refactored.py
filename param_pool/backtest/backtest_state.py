...
from ali2026v3_trading.infra.resilience import safe_divide  # R5-5
from ali2026v3_trading.infra.shared_trading_constants import REASON_MULTIPLIERS
from ali2026v3_trading.param_pool._param_grids import _compute_dynamic_slippage_bps  # noqa: F401
from ali2026v3_trading.infra.commission_utils import compute_commission as _compute_commission  # noqa: F401 re-export
...
from ali2026v3_trading.param_pool.backtest.backtest_config import (  # noqa: F401
...
def check_stop_profit_loss(pos, price, params):
    from ali2026v3_trading.infra.resilience import should_trigger_take_profit, should_trigger_stop_loss
