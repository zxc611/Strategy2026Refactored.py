...
if str(PARAM_POOL_DIR.parent) not in sys.path and os.path.isdir(str(PARAM_POOL_DIR.parent)): sys.path.insert(0, str(PARAM_POOL_DIR.parent))
...
def verify_module_imports():
    ...
    try:
        from strategy_judgment.strategy_judgment_engine import judge_backtest_result
...
def verify_behavioral_checks() -> Dict[str, Any]:
    ...
    try:
        from ali2026v3_trading.param_pool.test_design_suite import MustFailTestSuite
