...
from infra.serialization_utils import json_loads  # R4-02: 替代import json
...
from param_pool._param_grids import P0_IRON_RULES
...
def _run_e13_collusion_checks(
    ...
    """执行E13影子策略同谋检测。"""
    try:
        from governance.governance_engine import E13ShadowStrategyCollusionDetector
