...
class DeepValidationSuite:
    ...
    def validate_regime_robustness(self, params: Dict, bar_data: Any = None,
        ...
        try:
            from param_pool.backtest.backtest_config import validate_regime_robustness as _ts_validate_regime
            import pandas as pd
    ...
    def validate_cross_strategy_correlation(self, params_s1: Dict, params_s2: Dict,
        ...
        try:
            from param_pool.backtest.backtest_config import validate_cross_strategy_correlation as _ts_validate_corr
            if bar_data is None or not isinstance(bar_data, pd.DataFrame) or bar_data.empty:
    ...
    def validate_hft_temporal_robustness(self, params: Dict, bar_data: Any = None,
        ...
        try:
            from param_pool.backtest.backtest_config import validate_hft_temporal_robustness as _ts_validate_hft
            if bar_data is None or not isinstance(bar_data, pd.DataFrame) or bar_data.empty:
    ...
    def validate_market_friendliness_baseline(self, bar_data: Any = None,
        ...
        try:
            from param_pool.backtest.backtest_config import validate_market_friendliness_baseline as _ts_validate_mf
            if bar_data is None or not isinstance(bar_data, pd.DataFrame) or bar_data.empty:
    ...
    def validate_logic_transferability(self, params: Dict, bar_data_primary: Any = None,
        ...
        try:
            from param_pool.backtest.backtest_config import validate_logic_transferability as _ts_validate_lt
    ...
    def validate_liquidity_stress(self, params: Dict, bar_data: Any = None,
        ...
        try:
            from param_pool.backtest.backtest_config import validate_liquidity_stress as _ts_validate_liq
    ...
    def validate_doomed_tests(self, params: Dict, bar_data: Any = None,
        ...
        try:
            from param_pool.backtest.backtest_config import validate_doomed_tests as _ts_validate_doomed
    ...
    def validate_static_code_audit(self, engine_source_code: str = None) -> Dict[str, Any]:
        ...
        try:
            from param_pool.quantification.meta_audit_passport import MetaAuditEngine
    ...
    def validate_sandbox_execution(self, engine_class: type = None,
        ...
        try:
            from param_pool.quantification.meta_audit_passport import SandboxExecutionAuditor
