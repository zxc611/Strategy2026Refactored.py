...
# R35-P1-2标注: 此模块已集成到ts_backtest_strategies.py回测管线(triple_truth_anchor校验)，
# 非死代码。调用链: ts_backtest_strategies._run_backtest -> TripleTruthAnchor.train_and_validate
# 另被test_l1_l2_pipeline.py测试引用。
