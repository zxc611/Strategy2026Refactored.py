...
def _compute_dynamic_slippage_bps(
    ...
    """
    from infra.shared_utils import compute_slippage_bps as _unified_slippage
...
from param_pool._param_defaults import (  # noqa: F401
    ARB_STOP_LOSS_GRID,
...
try:
    from param_pool.backtest_runner_base import _sync_reason_multipliers_with_position_service
...
from infra.commission_utils import P0_IRON_RULES  # noqa: F401
...
def _ensure_backtest_thresholds():
    ...
    try:
        from param_pool.backtest_config import BACKTEST_THRESHOLDS as _bt
...
try:
    from param_pool.backtest_runner_base import _sync_thresholds_from_runtime_config
    _sync_thresholds_from_runtime_config()
except (ImportError, AttributeError):
    pass

from param_pool._param_defaults import SHADOW_PARAM_MAP, STRATEGY_SHADOW_DEFAULTS  # 五唯一性修复：统一从 _param_defaults 导入（STRATEGY_SHADOW_DEFAULTS含divergence项，修复此前缺失BUG）
...
SORTER_SCHEME_PARAM_GRID = {
    ...
    'tier2_coverage_threshold': [0.15, 0.20, 0.25, 0.30, 0.40, 0.50],  # FIX-FF R12-4-1: 含代码默认0.20
