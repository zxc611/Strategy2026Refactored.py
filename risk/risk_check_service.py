...
from infra.resilience import stable_mean, stable_variance

from infra.security_service import structured_audit_log  # R1-4修复

from risk.risk_check_engine import RiskCheckEngine

from risk.risk_circuit_breaker import get_safety_meta_layer

from risk.risk_support import safe_get_float as _safe_get_float, safe_get_int as _safe_get_int
...
class RiskCheckService:
    ...
    def _rule_engine(self) -> RiskCheckEngine:
        ...
        if self._rule_engine_instance is None:
            ...
            from risk.risk_check_engine import create_default_risk_check_engine
    ...
    def _get_types(self):
        ...
        from risk.risk_service import RiskCheckResponse, RiskCheckResult, RiskLevel, AlertLevel
    ...
    def check_before_trade(self, signal: Dict[str, Any]):
        ...
        if PhaseFeatureFlag.is_enabled('USE_RISK_CHECK_ENGINE'):
            ...
            try:
                ...
                from risk.risk_check_engine import RiskContext
    ...
    def detect_abnormal_trading(self, instrument_id: str = '', direction: str = '',
        ...
        try:
            ...
            from risk_engine.abnormal_trade_detector import AbnormalTradeDetector
