...
from infra.shared_utils import safe_int, safe_float, CHINA_TZ as _CHINA_TZ  # P2-13: 统一CHINA_TZ
...
class HardTimeStopAndComplianceService:
    ...
    def check_position_hard_time_stop(self, position_id: str, open_time,
        ...
        if position_id in self._closing_positions:
            _closing_age = time.time() - self._closing_positions[position_id]
            if _closing_age < 1800:
                return None
            else:
                del self._closing_positions[position_id]
        ...
        if elapsed_min >= stage1_min and max_profit_reached < stage1_threshold:
            ...
            self._closing_positions[position_id] = time.time()
    ...
    def clear_closing_flag(self, position_id: str) -> None:
        ...
        with self._lock:
            ...
            if approval_context is None or not approval_context.get('approver_id'):
                ...
                try:
                    ...
                    from risk.risk_service import alert as _alert, AlertLevel as _AlertLevel
