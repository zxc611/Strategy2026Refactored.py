...
from risk.safety_meta_equity import DrawdownMonitorService

from risk.safety_meta_position import HardTimeStopAndComplianceService
...
class SafetyMetaLayer:
    ...
    def clear_closing_flag(self, position_id: str) -> None:
        ...
        self._hard_time_stop_svc.clear_closing_flag(position_id)
