...
class TestQuantPlatform:
    def test_exchange_time_init(self):
        from ali2026v3_trading.data.quant_platform import ExchangeTime
    ...
    def test_tick_aggregator_init(self):
        from ali2026v3_trading.data.quant_platform import TickAggregator
    ...
    def test_atomic_system_state_init(self):
        from ali2026v3_trading.data.quant_platform import AtomicSystemState
        state = AtomicSystemState()
        assert state is not None

    def test_system_health_monitor_init(self):
        from ali2026v3_trading.data.quant_platform import SystemHealthMonitor
...
class TestQuantVolatility:
    def test_iv_surface_pca_init(self):
        from ali2026v3_trading.data.quant_volatility import IVSurfacePCA
        pca = IVSurfacePCA(window=50)
        assert pca is not None

    def test_volatility_regime_filter_init(self):
        from ali2026v3_trading.data.quant_volatility import VolatilityRegimeFilter
...
class TestStorageQueryModules:
    def test_storage_query_import(self):
        from ali2026v3_trading.data.storage_query import StorageQuery
...
# ============================================================
# 15. ali2026v3_trading.infra.shared_providers
# ============================================================
class TestSharedProviders:
    def test_state_provider_is_protocol(self):
        from ali2026v3_trading.infra.shared_providers import StateProvider
    ...
    def test_lock_provider_is_protocol(self):
        from ali2026v3_trading.infra.shared_providers import LockProvider
        assert hasattr(LockProvider, 'lock')

    def test_stats_provider_is_protocol(self):
        from ali2026v3_trading.infra.shared_providers import StatsProvider
        assert hasattr(StatsProvider, 'stats')
        assert hasattr(StatsProvider, 'record_tick')

    def test_safety_provider_is_protocol(self):
        from ali2026v3_trading.infra.shared_providers import SafetyProvider
...
# ============================================================
# 27. ali2026v3_trading.strategy.box_spring_executor_helpers
# ============================================================
class TestBoxSpringExecutorHelpers:
    ...
    def test_record_spring_trade(self):
        from ali2026v3_trading.strategy.box_spring_executor_helpers import _record_spring_trade
        result = _record_spring_trade({"signal_id": "sig_001"})
        assert result["recorded"] is True
        assert result["signal_id"] == "sig_001"

    def test_find_straddle_pair(self):
        from ali2026v3_trading.strategy.box_spring_executor_helpers import _find_straddle_pair
...
class TestDeletedShimsUnreachable:
    ...
    def test_infra_exception_layers_deleted(self):
        with pytest.raises(ModuleNotFoundError):
            import ali2026v3_trading.infra.exception_layers
