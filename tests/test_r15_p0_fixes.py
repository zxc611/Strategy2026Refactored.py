...
class TestSecurityFixes:
    ...
    def test_restricted_exec_blocks_import(self):
        from ali2026v3_trading.param_pool.l1_quantification.v7_meta_audit_v2 import RestrictedExecLoader
...
class TestMinuteBoundaryActivation:
    ...
    def test_minute_boundary_config_exists(self):
        try:
            from ali2026v3_trading.param_pool.preprocess_ticks import ENABLE_MINUTE_BOUNDARY_CHECK
