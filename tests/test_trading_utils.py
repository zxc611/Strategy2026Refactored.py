...
class TestComputeCommission:
    ...
    def test_50etf_option_open(self):
        """50ETF期权开仓"""
        from infra.trading_utils import compute_commission
    ...
    def test_get_commission_per_lot(self):
        ...
        from infra.trading_utils import get_commission_per_lot
    ...
    def test_estimate_commission_simple(self):
        ...
        from infra.trading_utils import estimate_commission_simple
    ...
    def test_calc_trade_fee(self):
        ...
        from infra.trading_utils import calc_trade_fee
        open_t = datetime(2026, 1, 1, 9, 0, 0)
...
class TestClassifyDeviation:
    ...
    def test_both_none_is_match(self):
        """两侧均无信号 => MATCH"""
        from infra.trading_utils import classify_deviation
        result = classify_deviation(None, None)
        assert result.category == 'MATCH'

    def test_identical_signals_match(self):
        """完全一致 => MATCH"""
        from infra.trading_utils import classify_deviation, Signal
...
class TestClassifySignalSequence:
    ...
    def test_length_mismatch_returns_error(self):
        """序列长度不一致 => 错误"""
        from infra.trading_utils import classify_signal_sequence, Signal
...
class TestThreadSafeCounter:
    ...
    def test_initial_value(self):
        """初始值"""
        from infra.trading_utils import ThreadSafeCounter
...
class TestThreadSafeDict:
    ...
    def test_set_and_get(self):
        """set+get"""
        from infra.trading_utils import ThreadSafeDict
        d = ThreadSafeDict()
        d.set('key', 'value')
...
class TestOtherUtilities:
    ...
    def test_safe_equity_update_normal(self):
        ...
        from infra.trading_utils import safe_equity_update
    ...
    def test_unified_slippage_model_buy(self):
        ...
        from infra.trading_utils import UnifiedSlippageModel
    ...
    def test_unified_position_sizer(self):
        ...
        from infra.trading_utils import UnifiedPositionSizer
    ...
    def test_backtest_order_splitter(self):
        ...
        from infra.trading_utils import BacktestOrderSplitter
    ...
    def test_perf_monitor(self):
        """perf_monitor上下文管理器"""
        from infra.trading_utils import perf_monitor, get_perf_stats
    ...
    def test_safe_execute_normal(self):
        """safe_execute正常执行"""
        from infra.trading_utils import safe_execute
