...
class TestDefaultStateProvider:
    ...
    def test_satisfies_protocol(self):
        from ali2026v3_trading.infra.shared_providers import DefaultStateProvider, StateProvider
        provider = DefaultStateProvider()
...
class TestDefaultLockProvider:
    ...
    def test_satisfies_protocol(self):
        from ali2026v3_trading.infra.shared_providers import DefaultLockProvider, LockProvider
        provider = DefaultLockProvider()
...
class TestDefaultStatsProvider:
    ...
    def test_satisfies_protocol(self):
        from ali2026v3_trading.infra.shared_providers import DefaultStatsProvider, StatsProvider
        provider = DefaultStatsProvider()
...
class TestDefaultSafetyProvider:
    ...
    def test_satisfies_protocol(self):
        from ali2026v3_trading.infra.shared_providers import DefaultSafetyProvider, SafetyProvider
        provider = DefaultSafetyProvider()
