...
class TestWidthCacheDiagnosisMixin:
    def test_class_exists(self):
        from ali2026v3_trading.data.width_cache_diagnosis_mixin import WidthCacheDiagnosisMixin
    ...
    def test_alias_exists(self):
        from ali2026v3_trading.data.width_cache_diagnosis_mixin import _WidthCacheDiagnosisMixin
        from ali2026v3_trading.data.width_cache_diagnosis_mixin import WidthCacheDiagnosisMixin
...
class TestEventPublisherReexport:
    ...
    def test_reexport_matches_source(self):
        from ali2026v3_trading.infra.event_publisher import EventPublisher as shim
...
class TestPhaseFeatureFlagReexport:
    ...
    def test_reexport_matches_source(self):
        from ali2026v3_trading.infra.phase_feature_flag import PhaseFeatureFlag as shim
        from ali2026v3_trading.infra.contracts_service import PhaseFeatureFlag as src
        assert shim is src
...
class TestServiceContractsReexport:
    ...
    def test_reexport_matches_source(self):
        ...
        from ali2026v3_trading.infra.contracts_service import ServiceProtocol as src
        assert shim is src
