...
class TestStrategy2026Instantiation(unittest.TestCase):
    ...
    def test_strategy_core_is_correct_type(self):
        from ali2026v3_trading.strategy_core_service import Strategy2026, StrategyCoreService
...
class TestStrategy2026Inheritance(unittest.TestCase):
    def test_inherits_base_strategy(self):
        from ali2026v3_trading.strategy_core_service import Strategy2026
        from ali2026v3_trading.strategy_core_service import BaseStrategy
        self.assertTrue(issubclass(Strategy2026, BaseStrategy))

    def test_inherits_ui_mixin(self):
        from ali2026v3_trading.strategy_core_service import Strategy2026
        from ali2026v3_trading.strategy_core_service import UIMixin
