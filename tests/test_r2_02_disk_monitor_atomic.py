...
def test_disk_monitor_uses_atomic_replace():
    ...
    from ali2026v3_trading.infra._disk_monitor import DiskSpaceMonitor
...
def test_disk_monitor_imports_atomic_replace():
    """_disk_monitor 应从 shared_utils_infra 导入 atomic_replace_file"""
    import ali2026v3_trading.infra._disk_monitor as mod
    assert hasattr(mod, 'atomic_replace_file'), \
        "_disk_monitor 模块应导入 atomic_replace_file"
