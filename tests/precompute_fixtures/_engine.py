...
from ali2026v3_trading.param_pool.precompute._schema import (
    SCHEMA_REQUIRED_COLUMNS_V5,
    sync_db_schema_v5,
)
from ali2026v3_trading.param_pool.precompute._params import PrecomputeParams
...
def _enrich_bars_with_cycle_resonance(
    ...
    from ali2026v3_trading.param_pool.precompute._hmm import (
        compute_hmm_state_vectorized,
    )
    from ali2026v3_trading.param_pool.precompute._trend_scores import (
    ...
    if use_vectorized:
        try:
            from ali2026v3_trading.param_pool.precompute._cycle_resonance_vec import (
...
class PrecomputeEngine:
    ...
    def _precompute_symbol(self, symbol: str, since_date: Optional[str] = None) -> int:
        ...
        try:
            ...
            from ali2026v3_trading.param_pool.precompute._kl_rpd import (
                compute_kl_rpd_vectorized,
            )
            from ali2026v3_trading.param_pool.precompute._obos import (
                compute_obos_vectorized,
            )
            from ali2026v3_trading.param_pool.precompute._pullback import (
            ...
            from ali2026v3_trading.param_pool.precompute._signals import (
            ...
            from ali2026v3_trading.param_pool.precompute._l0_state import (
                compute_l0_state_vectorized,
            )
            from ali2026v3_trading.param_pool.precompute._signal_decay import (
                compute_decay_and_linkage_vectorized,
            )
            from ali2026v3_trading.param_pool.precompute._position_decision import (
    ...
    def run_daily_pivot_precompute(self) -> None:
        from ali2026v3_trading.data.db_adapter import connect
        from ali2026v3_trading.param_pool.precompute._daily_pivot import (
